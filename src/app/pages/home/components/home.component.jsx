...
const HomeComponent = () => {
  return (
    <HomeComponentContainer>
      <Home>
        <HomeTextContainer>
          <HomeText textType='heading'>Welcome to Task Maven</HomeText>
          <HomeText textType='normal'>
            Task Maven is a project/sprint management app inspired by Notion's
            Kanban.
          </HomeText>
          <HomeText textType='normal'>
        ...
        <HomeLinks>
          <HomeLink
            href='https://github.com/abystoma/task-maven'
            target='_blank'
          ...
          <HomeLink
            href='https://www.linkedin.com/in/zayed-humayun/'
            target='_blank'
            rel='noopener noreferrer'
          >
